  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "temporary_media" ("id" SERIAL PRIMARY KEY, "mediaType" varchar NOT NULL, "tmdbId" integer NOT NULL, "tvdbId" integer, "imdbId" varchar, "status" integer NOT NULL DEFAULT (1), "createdAt" timestamp NOT NULL DEFAULT (now()), "updatedAt" timestamp NOT NULL DEFAULT (now()), "lastSeasonChange" timestamp NOT NULL DEFAULT (transaction_timestamp()), "status4k" integer NOT NULL DEFAULT (1), "mediaAddedAt" timestamp, CONSTRAINT "UQ_41a289eb1fa489c1bc6f38d9c3c" UNIQUE ("tvdbId"))`
